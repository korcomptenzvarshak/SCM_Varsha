...
private countryStateList = [
    ...
    getCountries(): string[] {
        return this.countryStateList.map(item => item.country);
      }
    
    getStatesByCountry(country: string): string[] | undefined {
        const selectedCountry = this.countryStateList.find(item => item.country === country);
        return selectedCountry?.states || [];
    }
    getCountryByCountryName(country: string): any {
        const selectedCountry = this.countryStateList.find(item => item.country === country);
